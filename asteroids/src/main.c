...
int main(int argc, char **argv)
{
    ...
    glutInit(&argc, argv);
    // initialise asteroid explosion alpha to 0 to prevent rendering before first asteroid is destroyed
    asteroid_explosion.alpha = 0;
...
void display(void)
{
    ...
    // only render asteroid explosion while it is still visible (opacity)
